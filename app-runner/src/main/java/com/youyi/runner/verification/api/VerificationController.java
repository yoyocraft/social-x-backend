...
public class VerificationController {
    ...
    public Result<ImageCaptchaResponse> notifyImageCaptcha() {
        VerificationDO verificationDO = verificationHelper.verifyImageCaptcha();
        return notifyImageCaptchaSuccess(verificationDO);
    }
}
